...
class RRulePickerLocalizationsTr extends RRulePickerLocalizations {
  ...
  @override
  String get rrulePickerDayOfMonth => 'Ayın günü';

  @override
  String get rrulePickerDayOfWeek => 'Haftanın günü';
  ...
  @override
  String get rrulePickerEndAfterDate => 'Tarihten sonra bitiş';
  ...
  String rrulePickerFirstDayOfWeek(String dayOfWeek) {
    String _temp0 = intl.Intl.selectLogic(dayOfWeek, {'other': 'ilk'});
    return '$_temp0';
  }

  @override
  String rrulePickerFourthDayOfWeek(String dayOfWeek) {
    String _temp0 = intl.Intl.selectLogic(dayOfWeek, {'other': 'dördüncü'});
    return '$_temp0';
  }

  @override
  String get rrulePickerLastDay => 'son';

  @override
  String rrulePickerLastDayOfWeek(String dayOfWeek) {
    String _temp0 = intl.Intl.selectLogic(dayOfWeek, {'other': 'son'});
    return '$_temp0';
  }
  ...
  String rrulePickerSecondDayOfWeek(String dayOfWeek) {
    String _temp0 = intl.Intl.selectLogic(dayOfWeek, {'other': 'ikinci'});
    return '$_temp0';
  }

  @override
  String get rrulePickerSkip => 'Atla';

  @override
  String rrulePickerThirdDayOfWeek(String dayOfWeek) {
    String _temp0 = intl.Intl.selectLogic(dayOfWeek, {'other': 'üçüncü'});
    return '$_temp0';
  }
